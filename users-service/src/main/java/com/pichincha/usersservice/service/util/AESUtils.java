package com.pichincha.usersservice.service.util;
...
public class AESUtils {
    ...
    public static String decryptText(String cipherText, String secret, boolean isMobile) {
//        if (isMobile) Security.addProvider(new org.bouncycastle.jce.provider.BouncyCastleProvider());
        ...
        try {
            ...
            Cipher aesCBC = isMobile ? Cipher.getInstance("AES/CBC/PKCS7Padding") : Cipher.getInstance("AES/CBC/PKCS5Padding");
