...
import com.pichincha.authorizationserver.domain.OAuthClientAuthorization;
import com.pichincha.authorizationserver.repository.OAuthClientAuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public JpaOAuth2AuthorizationService(OAuthClientAuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository) {
...
//        this.objectMapper.addMixIn(Authority.class, AuthorityMixin.class);
    ...
    public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
        ...
        Optional<OAuthClientAuthorization> result;
        if (tokenType == null) {
    ...
    private OAuth2Authorization toObject(OAuthClientAuthorization entity) {
        RegisteredClient registeredClient = this.registeredClientRepository.findById(entity.getRegisteredClientId());
        if (registeredClient == null) {
            throw new DataRetrievalFailureException(
                    "The RegisteredClient with id '" + entity.getRegisteredClientId() + "' was not found in the JpaRegisteredClientRepository.");
        }
    ...
    private OAuthClientAuthorization toEntity(OAuth2Authorization authorization) {
        OAuthClientAuthorization entity = new OAuthClientAuthorization();
